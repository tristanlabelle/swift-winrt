...
internal enum SecondaryInterfaces {
    internal static func writeDeclaration(
        ...
        // private [static] var _lazyIStringable: COM.COMReference<SWRT_WindowsFoundation_IStringable>.Optional = nil
        ...
        writer.writeStoredProperty(visibility: .private, static: `static`, declarator: .var, name: storedPropertyName,
            type: SupportModules.COM.comReference_Optional(to: abiStructType), initialValue: "nil")

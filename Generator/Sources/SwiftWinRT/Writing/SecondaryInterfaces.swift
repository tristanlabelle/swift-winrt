...
internal enum SecondaryInterfaces {
    internal static func writeDeclaration(
        ...
        let storedPropertyName = getStoredPropertyName(interface)
        ...
        writer.writeComputedProperty(
                visibility: .internal, static: `static`, name: getPropertyName(interface),
    ...
    internal static func getPropertyName(_ interface: BoundInterface, suffix: String? = nil) -> String {
        var name = "_" + Casing.pascalToCamel(interface.definition.nameWithoutGenericArity)
    ...
    fileprivate static func getStoredPropertyName(_ interface: BoundInterface) -> String {
        "_lazy" + interface.definition.nameWithoutGenericArity
    }
}
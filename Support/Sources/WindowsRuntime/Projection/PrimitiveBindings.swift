...
public enum BooleanBinding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createBoolean)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createBooleanArray)
    }
}

public enum UInt8Binding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt8)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt8Array)
    }
}

public enum Int16Binding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createInt16)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createInt16Array)
    }
}

public enum UInt16Binding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt16)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt16Array)
    }
}

public enum Int32Binding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createInt32)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createInt32Array)
    }
}

public enum UInt32Binding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt32)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt32Array)
    }
}

public enum Int64Binding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createInt64)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createInt64Array)
    }
}

public enum UInt64Binding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt64)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createUInt64Array)
    }
}

public enum SingleBinding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createSingle)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createSingleArray)
    }
}

public enum DoubleBinding: IReferenceableBinding, IdentityBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createDouble)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createDoubleArray)
    }
}

public enum Char16Binding: IReferenceableBinding, PODBinding {
    ...
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createChar16Array)
    }
}

public enum StringBinding: IReferenceableBinding {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, valueBinding: Self.self, factory: PropertyValueStatics.createString)
    }

    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createStringArray)
    }
}

public enum GuidBinding: IReferenceableBinding, PODBinding {
    ...
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, valueBinding: Self.self, factory: PropertyValueStatics.createGuidArray)
    }
}
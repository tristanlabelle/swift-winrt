...
public enum BooleanProjection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createBoolean)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createBooleanArray)
    }
}

public enum UInt8Projection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createUInt8)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createUInt8Array)
    }
}

public enum Int16Projection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createInt16)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createInt16Array)
    }
}

public enum UInt16Projection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createUInt16)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createUInt16Array)
    }
}

public enum Int32Projection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createInt32)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createInt32Array)
    }
}

public enum UInt32Projection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createUInt32)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createUInt32Array)
    }
}

public enum Int64Projection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createInt64)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createInt64Array)
    }
}

public enum UInt64Projection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createUInt64)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createUInt64Array)
    }
}

public enum SingleProjection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createSingle)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createSingleArray)
    }
}

public enum DoubleProjection: IReferenceableProjection, ABIIdentityProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createDouble)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createDoubleArray)
    }
}

public enum Char16Projection: IReferenceableProjection, ABIInertProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createChar16)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createChar16Array)
    }
}

public enum StringProjection: IReferenceableProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createString)
    }

    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createStringArray)
    }
}

public enum GuidProjection: IReferenceableProjection, ABIInertProjection {
    ...
    public static func createIReference(_ value: SwiftValue) throws -> WindowsFoundation_IReference<SwiftValue> {
        try PropertyValueStatics.createIReference(value, projection: Self.self, factory: PropertyValueStatics.createGuid)
    }
    public static func createIReferenceArray(_ value: [SwiftValue]) throws -> WindowsFoundation_IReferenceArray<SwiftValue> {
        try PropertyValueStatics.createIReferenceArray(value, projection: Self.self, factory: PropertyValueStatics.createGuidArray)
    }
}
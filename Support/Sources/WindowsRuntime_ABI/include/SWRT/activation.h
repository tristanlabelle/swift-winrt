...
struct SWRT_IActivationFactory_VirtualTable {
    ...
    SWRT_HResult (__stdcall *GetIids)(SWRT_IActivationFactory* _Nonnull _this, uint32_t* iidCount, SWRT_Guid** iids);
    SWRT_HResult (__stdcall *GetRuntimeClassName)(SWRT_IActivationFactory* _Nonnull _this, SWRT_HString* className);
    SWRT_HResult (__stdcall *GetTrustLevel)(SWRT_IActivationFactory* _Nonnull _this, SWRT_TrustLevel* trustLevel);
    SWRT_HResult (__stdcall *ActivateInstance)(SWRT_IActivationFactory* _Nonnull _this, SWRT_IInspectable** instance);
};

...
struct SWRT_IInspectable_VirtualTable {
    ...
    SWRT_HResult (__stdcall *GetIids)(SWRT_IInspectable* _Nonnull _this, uint32_t* iidCount, SWRT_Guid** iids);
    SWRT_HResult (__stdcall *GetRuntimeClassName)(SWRT_IInspectable* _Nonnull _this, SWRT_HString* className);
    SWRT_HResult (__stdcall *GetTrustLevel)(SWRT_IInspectable* _Nonnull _this, SWRT_TrustLevel* trustLevel);
};

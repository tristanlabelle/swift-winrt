...
extension COMImport {
    public func _withOutParam<ValueProjection: ABIProjection>(
            ...
            _ body: (UnsafeMutablePointer<ValueProjection.ABIValue>) -> CWinRTCore.SWRT_HResult) throws -> ValueProjection.SwiftValue {
    ...
    public func _getter<Value>(
            _ function: (Projection.ABIValue, UnsafeMutablePointer<Value>?) -> CWinRTCore.SWRT_HResult) throws -> Value {
    ...
    public func _getter<ValueProjection: ABIProjection>(
            _ function: (Projection.ABIValue, UnsafeMutablePointer<ValueProjection.ABIValue>?) -> CWinRTCore.SWRT_HResult,
    ...
    public func _setter<Value>(
            _ function: (Projection.ABIValue, Value) -> CWinRTCore.SWRT_HResult, 
            _ value: Value) throws {
        try HResult.throwIfFailed(function(comPointer, value))
    }

    public func _setter<ValueProjection: ABIProjection>(
            _ function: (Projection.ABIValue, ValueProjection.ABIValue) -> CWinRTCore.SWRT_HResult,
